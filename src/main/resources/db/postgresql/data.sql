...
INSERT INTO topics (id, creation_date, description, html_content, name, required, status, update_date, created_by_id, discipline_id) VALUES (36, '2021-03-16', '	Esta disciplina mostra como construir estruturas de dados dinâmicas que crescem e encolhem em tempo de execução. As listas
...
INSERT INTO topics (id, creation_date, description, html_content, name, required, status, update_date, created_by_id, discipline_id) VALUES (17, '2021-03-13', 'Uma pilha é uma versão limitada de uma lista — novos nós podem ser inseridos e removidos de uma pilha apenas na parte
...
INSERT INTO topics (id, creation_date, description, html_content, name, required, status, update_date, created_by_id, discipline_id) VALUES (15, '2021-03-13', 'Uma lista encadeada é uma coleção linear (isto é, uma sequência) de objetos de classe autorreferencial, chamados nós, conectados
...
INSERT INTO questions (id, creation_date, description, status, type, update_date, topic_id, user_id) VALUES (28, '2021-03-16 13:14:54.702', '<p>Preencha a lacuna da seguinte afirmação abaixo:</p><p><br></p><p>Uma classe ________ é utilizada para formar estruturas de dados dinâmicas que podem crescer e encolher em tempo de execução.</p>', 'WAITING_FOR_RESPONSE', 'QUIZ', '2021-03-16 13:14:54.702', 37, NULL);
INSERT INTO questions (id, creation_date, description, status, type, update_date, topic_id, user_id) VALUES (29, '2021-03-16 14:06:54.968', '<p>O que acontece quando se deseja inserir um elemento em uma FILA que já está cheia?</p>', 'WAITING_FOR_RESPONSE', 'QUIZ', '2021-03-16 14:06:54.968', 18, NULL);
